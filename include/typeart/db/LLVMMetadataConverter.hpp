...
class LLVMMetadataConverter {
 ...
 public:
  ...
  [[nodiscard]] Ref<Meta> convert(Database& db, const llvm::Metadata* llvm_meta);
 ...
 private:
  ...
  Ref<MetaClass> lookup_meta(const llvm::Metadata* llvm_meta);
  ...
  [[nodiscard]] Ref<di::CompositeType> convertDICompositeType(const llvm::DICompositeType& di_type);
