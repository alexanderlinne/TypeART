...
int main(int argc, char** argv) {
  ...
  // CHECK-NEXT: Total free stack           : 418 ,  0 ,    -
  ...
  // CHECK: double[32] : 0 ,    200
  // CHECK: float[32] : 0 ,    200
  ...
  // CHECK-NEXT: Thread Stack Allocs      : 2{{[0-9][0-9]}} ,   2{{[0-9][0-9]}}
  // CHECK-NEXT: Thread Stack Arrays      : 0 ,    0
  // CHECK-NEXT: Thread Max. Stack Allocs : {{[0-9]+}} ,   {{[0-9]+}}
  // CHECK-NEXT: Thread Stack Allocs Free : 2{{[0-9][0-9]}} ,  2{{[0-9][0-9]}}
