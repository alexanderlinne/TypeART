...
// CHECK-NEXT: call void @typeart_tracker_alloc(i8* [[POINTER]], i32 {{[0-9]*}}, i64 5)
// CHECK: bitcast i8* [[POINTER]] to i32*

// CHECK: [[POINTER2:%[0-9a-z]+]] = call noalias{{( align [0-9]+)?}} i8* @aligned_alloc(i64 128, i64 [[SIZE:%[0-9a-z]+]])
// CHECK-NOT: call void @typeart_tracker_alloc(i8* [[POINTER2]], i32 {{[0-9]*}}, i64 [[SIZE]])
// CHECK: call void @typeart_tracker_alloc(i8* [[POINTER2]], i32 {{[0-9]*}}, i64 %{{[0-9a-z]+}})
