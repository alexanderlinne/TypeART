...
// CHECK: [[POINTER:%[0-9a-z]+]] = call noalias i8* @_ZnamSt11align_val_tRKSt9nothrow_t(i64{{( noundef)?}} 40,
// CHECK-NEXT: call void @typeart_tracker_alloc(i8* [[POINTER]], i32 [[ID:[0-9]*]], i64 10)

// CHECK: [[POINTER2:%[0-9a-z]+]] = call noalias i8* @_ZnwmSt11align_val_tRKSt9nothrow_t(i64{{( noundef)?}} 4,
